...
public class GettyImageFactory {
  @Inject public GettyImageFactory() {
  }

  public GettyImageViewModel createGettyImageViewModel(int id, ImageResult imageResult,
      GettyImageViewModel.Listener listener) {
