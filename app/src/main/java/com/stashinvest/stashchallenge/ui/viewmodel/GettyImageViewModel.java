...
public class GettyImageViewModel extends BaseViewModel<GettyImageViewHolder>
    implements LongPressGestureDetector.Listener {
  ...
  @Override public GettyImageViewHolder createItemViewHolder(View view) {
    return new GettyImageViewHolder(view);
  }

  @Override public void bindViewHolder(GettyImageViewHolder holder) {
    holder.bind(imageResult, this);
  }

  @Override public ViewModelType getViewType() {
    return GETTY_IMAGE;
  }
